...
SECRET_KEY = 'django-insecure-7gnitbji107@&_=ev5%(0mm@4%@z%+@hz!#_%jlpv7q17sw9iv'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # ここに静的ファイルのディレクトリを指定
]